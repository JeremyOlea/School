...
public class CourseCatalogue {
    ...
    public CourseOffering searchCourseOffering(Student student, String name, int secNum) {
        Course course = searchCatalogue(name);
		if (course == null)
			return null;

		CourseOffering co = searchSection(course, secNum);
		if (co == null)
			return null;
